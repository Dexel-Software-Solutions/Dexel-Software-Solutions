...
<p align="center">
  <img src="https://skillicons.dev/icons?i=java,python,rust,js,ts,html,css,react,flutter,nodejs,spring,mysql,postgres,mongodb,git,github,linux,docker,aws&perline=9" />
</p>
...
| Project | Description |
|------|------------|
|**Dexel Clock** | Dexel Analog Clock |
...
| **Phantom-Framework** | Offensive security framework built for ethical hackers |
